...
|------|------|------------|-------------|
| `FILE_PARAMETERS` | type([file_parameters_object](/api/src/lib/motion_file_abst_object#file-parameters-object)) | parameter | List of file named constants. |
...
|------|------|--------|------------|-------------|
| `self` | class([file_base_object](/api/src/lib/motion_file_abst_object#file-base-object)) | inout |  | File handler. |
