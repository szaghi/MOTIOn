...
|------|------|------------|-------------|
| `XH5F_PARAMETERS` | type([xh5f_parameters_object](/api/src/lib/motion_xh5f_file_object#xh5f-parameters-object)) | parameter | List of XH5F named constants. |
...
| `hdf5` | type([hdf5_file_object](/api/src/lib/motion_hdf5_file_object#hdf5-file-object)) |  | HDF5 file handler. |
| `xdmf` | type([xdmf_file_object](/api/src/lib/motion_xdmf_file_object#xdmf-file-object)) |  | XDMF file handler. |
...
|------|------|--------|------------|-------------|
| `self` | class([xh5f_file_object](/api/src/lib/motion_xh5f_file_object#xh5f-file-object)) | inout |  | File handler. |
...
| `nijk` | integer(kind=HSIZE_T) | in | optional | Cells number. |
...
**Returns**: type([xh5f_file_object](/api/src/lib/motion_xh5f_file_object#xh5f-file-object))
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `hdf5` | type([hdf5_file_object](/api/src/lib/motion_hdf5_file_object#hdf5-file-object)) | in | optional | HDF5 file handler. |
| `xdmf` | type([xdmf_file_object](/api/src/lib/motion_xdmf_file_object#xdmf-file-object)) | in | optional | XDMF file handler. |
